...
namespace Tyuiu.DubrovinSN.Sprint5.Task6.V17
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* есть символьных данных.Найти количество пробелов, идущих подряд больше  *");
            Console.WriteLine("* одного, в заданной строке.                                              *");
            Console.WriteLine("***************************************************************************");
